...
def _sidebar():
    with st.sidebar:
        ...
        st.markdown("**All Scanners:**")
        st.markdown("- [🏛️ Livermore Pivotal](http://localhost:8502/?scanner=livermore)")
        ...
        st.markdown("- [➡️ EMA Crossover](http://localhost:8502/?scanner=ema)")
        ...
        st.markdown("- [〰️ MACD Scanner](http://localhost:8502/?scanner=macd)")
